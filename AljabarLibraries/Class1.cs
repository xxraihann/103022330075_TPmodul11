    ...
    public class Aljabar
    {
        public static double[] AkarPersamaanKuadrat(double[] persamaan)
        {
            if (persamaan.Length != 3)
                throw new ArgumentException("Array harus memiliki 3 elemen: a, b, c");
            ...
            if (diskriminan < 0)
                throw new Exception("Akar imajiner tidak didukung");
        ...
        public static double[] HasilKuadrat(double[] persamaan)
        {
            if (persamaan.Length != 2)
                throw new ArgumentException("Array harus memiliki 2 elemen: a, b");
